...
def hello():
    ...
    class Employee:
        def __init__(self,root):
            ...
            self.root.geometry("1368x560+200+50")
    ...
    #===========================================Defining=========================================================================
            def insert():
                mycon= sql.connect(host="sql6.freemysqlhosting.net", user="sql6474292", password="tiger", database="sql6474292")
                cursor=mycon.cursor()
                ...
                s = "INSERT INTO emp(fname,lname,email,phone,age,empno,salary,dob,joindate,qual,desig,schedule) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
 ...
 #===============================================BUTTONS====================================================================
            ...
            button1= Button(buttonframe,text="Print Data", command=press,font=("consolas",15,"bold"),bg="lime", width=30, height=1, padx=2, pady=6)
            button1.grid(row=0, column=0)

            button1= Button(buttonframe, text="Insert Data", font=("consolas",15,"bold"),bg="lime", width=30, height=1,command=insert,padx=2, pady=6)
